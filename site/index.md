...
- [Contributing to Metasploit]({% link docs/development/getting-started/Contributing-to-Metasploit.md %})
- [Creating Metasploit Framework LoginScanners]({% link docs/development/developing-modules/Creating-Metasploit-Framework-LoginScanners.md %})
...
- [Landing Pull Requests]({% link docs/development/maintainers/Landing-Pull-Requests.md %})

# Metasploit Development #

- [Style Tips]({% link docs/development/quality/Style-Tips.md %})
- [Get Started Writing an Exploit]({% link docs/development/developing-modules/Get-Started-Writing-an-Exploit.md %})
- [How to get started with writing an auxiliary module]({% link docs/development/developing-modules/How-to-get-started-with-writing-an-auxiliary-module.md %})
- [How to get started with writing a post module]({% link docs/development/developing-modules/How-to-get-started-with-writing-a-post-module.md %})
- [How to get started with writing a Meterpreter script]({% link docs/using-metasploit/meterpreter/How-to-get-started-with-writing-a-Meterpreter-script.md %})
- [Running Private Modules]({% link docs/using-metasploit/Running-Private-Modules.md %})
- [Exploit Ranking]({% link docs/using-metasploit/Exploit-Ranking.md %})
- [Module Reference Identifiers]({% link docs/development/developing-modules/Module-Reference-Identifiers.md %})
- [How to check Microsoft patch levels for your exploit]({% link docs/development/developing-modules/How-to-check-Microsoft-patch-levels-for-your-exploit.md %})
- [How to clean up files using FileDropper]({% link docs/development/developing-modules/How-to-clean-up-files-using-FileDropper.md %})
- [How to deprecate a Metasploit module]({% link docs/development/maintainers/How-to-deprecate-a-Metasploit-module.md %})
- [How to do reporting or store data in module development]({% link docs/development/developing-modules/How-to-do-reporting-or-store-data-in-module-development.md %})
- [How to log in Metasploit]({% link docs/development/developing-modules/How-to-log-in-Metasploit.md %})
- [How to obfuscate JavaScript in Metasploit]({% link docs/development/developing-modules/How-to-obfuscate-JavaScript-in-Metasploit.md %})
- [How to parse an HTTP response]({% link docs/development/developing-modules/How-to-parse-an-HTTP-response.md %})
...
- [How to use command stagers]({% link docs/development/developing-modules/How-to-use-command-stagers.md %})
- [How to use datastore options]({% link docs/development/developing-modules/How-to-use-datastore-options.md %})
- [How to use Msf Auxiliary AuthBrute to write a bruteforcer]({% link docs/development/developing-modules/How-to-use-Msf-Auxiliary-AuthBrute-to-write-a-bruteforcer.md %})
- [How to use PhpEXE to exploit an arbitrary file upload bug]({% link docs/development/developing-modules/How-to-use-PhpEXE-to-exploit-an-arbitrary-file-upload-bug.md %})
- [How to use Powershell in an exploit]({% link docs/development/developing-modules/How-to-use-Powershell-in-an-exploit.md %})
- [How to use Railgun for Windows post exploitation]({% link docs/development/developing-modules/How-to-use-Railgun-for-Windows-post-exploitation.md %})
- [How to Use the FILEFORMAT mixin to create a file format exploit]({% link docs/development/developing-modules/How-to-Use-the-FILEFORMAT-mixin-to-create-a-file-format-exploit.md %})
- [How to use the Msf Exploit Remote Tcp mixin]({% link docs/development/developing-modules/How-to-use-the-Msf-Exploit-Remote-Tcp-mixin.md %})
- [How to use the Seh mixin to exploit an exception handler]({% link docs/development/developing-modules/How-to-use-the-Seh-mixin-to-exploit-an-exception-handler.md %})
...
- [How to decode Base64 with Metasploit Framework Compiler]({% link docs/development/developing-modules/How-to-decode-Base64-with-Metasploit-Framework-Compiler.md %})
- [How to XOR with Metasploit Framework Compiler]({% link docs/development/developing-modules/How-to-XOR-with-Metasploit-Framework-Compiler.md %})
- [Using ReflectiveDll Injection]({% link docs/development/developing-modules/Using-ReflectiveDLL-Injection.md %})
- [Oracle Usage]({% link docs/using-metasploit/Oracle-Usage.md %})
- [Rex Layout]({% link docs/development/developing-modules/Rex-Layout.md %})
- [Definition of Module Reliability, Side Effects, and Stability]({% link docs/development/developing-modules/Definition-of-Module-Reliability,-Side-Effects,-and-Stability.md %})
...
- [Git Cheatsheet]({% link docs/development/maintainers/Git-cheatsheet.md %})
- [Git Reference Sites]({% link docs/development/maintainers/Git-Reference-Sites.md %})
