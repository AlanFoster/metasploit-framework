...
## Instructions
1. Set up a working Metasploit development setup as described at the [Setting Up a Development Environment]({% link docs/development/get-started/Setting-Up-a-Metasploit-Development-Environment.md %}) wiki page. Be sure to set up your SSH keys as part of this setup.
