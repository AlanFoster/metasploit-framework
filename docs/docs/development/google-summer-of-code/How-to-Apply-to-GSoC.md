...
A place to get started with contributing to Metasploit is [here](https://github.com/rapid7/metasploit-framework/blob/master/CONTRIBUTING.md) and expanded on [here]({% link docs/development/get-started/Contributing-to-Metasploit.md %}#framework-bugs-and-features).
