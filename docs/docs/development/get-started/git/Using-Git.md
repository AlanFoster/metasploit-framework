...
* [Cheatsheet]({% link docs/development/get-started/git/Git-cheatsheet.md %})
* [Reference Sites]({% link docs/development/get-started/git/Git-Reference-Sites.md %})
* [Setting Up a Metasploit Development Environment]({% link docs/development/get-started/Setting-Up-a-Metasploit-Development-Environment.md %}) - this will walk you through creating a pull request
* [Landing Pull Requests]({% link docs/development/maintainers/process/Landing-Pull-Requests.md %}) - this is the procedure that Metasploit core devs go through to merge your request
