...
To get a response, you can either use [Rex::Proto::Http::Client]({% link docs/development/developing-modules/libraries/http/How-to-send-an-HTTP-request-using-Rex-Proto-Http-Client.md %}), or the [HttpClient]({% link docs/development/developing-modules/libraries/http/How-to-Send-an-HTTP-Request-Using-HttpClient.md %}) mixin to make an HTTP request. If you are writing a module, you should use the mixin.
