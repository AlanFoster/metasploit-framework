...
To compile, use [How to use Metasploit::Framework::Compiler::Windows to compile C code]({% link docs/development/developing-modules/libraries/compiling/c/How-to-use-Metasploit-Framework-Compiler-Windows-to-compile-C-code.md %})