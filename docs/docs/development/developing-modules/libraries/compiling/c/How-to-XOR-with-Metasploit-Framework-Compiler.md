...
To compile, use [Metasploit::Framework::Compiler::Windows.compile_c]({% link docs/development/developing-modules/libraries/compiling/c/How-to-use-Metasploit-Framework-Compiler-Windows-to-compile-C-code.md %})