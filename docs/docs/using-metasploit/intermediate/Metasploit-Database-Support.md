...
## What's next?
That's it for the simple high level explanation of how to setup a database for metasploit. If that wasn't enough detail for you you can check out our more in depth explanation [here]({% link docs/using-metasploit/advanced/Metasploit-Web-Service.md %}).
