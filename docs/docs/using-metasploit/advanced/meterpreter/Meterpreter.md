 ...
 * [Powershell Extension]({% link docs/using-metasploit/advanced/meterpreter/Powershell-Extension.md %})

A wishlist of features is maintained at the [Meterpreter Wishlist]({% link docs/using-metasploit/advanced/meterpreter/Meterpreter-Wishlist.md %}) page.
...
Got dead Meterpreter sessions? Read this: [Debugging Dead Meterpreter Sessions]({% link docs/using-metasploit/advanced/meterpreter/Debugging-Dead-Meterpreter-Sessions.md %}).
