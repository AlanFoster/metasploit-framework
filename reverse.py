...
HTTP_HOST = None
HTTP_REFERER = None
PAYLOAD_UUID = '0d32a2cbe6cc8cc5c649d35da7de0926'
...
def error_result(exception=None):
    ...
    print("nameeeeeeeeeeeE" + exception.__class__.__name__)
...
def tlv_pack(*args):
    ...
    print("packing:")
    print(tlv)
    print("meta type: " + str((tlv['type'] >> 16) & 0xFFFF))
    print("value: " + str(tlv['type'] & 0xFFFF))
...
#             print(f"Decrypting packet with xor key {xor_key}")
...
class PythonMeterpreter(object):
    ...
    def create_response(self, request):
        ...
        if not reqid_tlv:
            return
        print("Packing req tlv id:")
        response += tlv_pack(reqid_tlv)

        print("Packing result tlv:")
